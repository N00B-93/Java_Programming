...
public class ExamScoresAndGrades
{
    public static void main(String[] args) {
        ...
        // Creates a file Object references the files containing student names and scores.
        File namesAndScoresFile = new File(inputFile);

        // Displays an error message if the file name entered by the user doesn't exist and terminates the program.
        ...
        // Creates a file Object referencing the file where the students name, scores, total score and grades will be stored.
